...
import { BloodLevelPoint } from '../../lib/api/client';

interface BloodLevelGraphPanelProps {
  bloodLevels: BloodLevelPoint[];
  substanceDisplayName: (idOrName: string) => string;
}

const BloodLevelGraphPanel: React.FC<BloodLevelGraphPanelProps> = ({
  bloodLevels,
...
export default BloodLevelGraphPanel;
