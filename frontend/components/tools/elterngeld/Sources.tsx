...
const GROUPS: { heading: string; sources: Source[] }[] = [
  {
    ...
    sources: [
      ...
      { cite: '§ 2e', used: 'the tax deduction, Steuerklasse IV and the flat 8 % Kirchensteuer', href: `${GESETZE}/beeg/__2e.html` },
  ...
  },
  {
    ...
    sources: [
      ...
      { cite: '§ 51a Abs. 2a EStG', used: 'SolZ and Kirchensteuer always use the Kinderfreibetrag base', href: `${GESETZE}/estg/__51a.html` },
