...
- Security headers: CSP, X-Frame-Options, X-Content-Type-Options, COOP/CORP (generated by `scripts/generate-csp.mjs`)
...
- [ ] Set `NEXT_PUBLIC_API_URL` at build time so the generated CSP `connect-src` covers your API origin
